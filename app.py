...
st.set_page_config(page_title="Market Intel: Weed Man Pricing Analysis", layout="wide", initial_sidebar_state="expanded")
...
with st.sidebar:
    ...
    st.markdown("---")
    st.info("""
    **Objective:** Reverse-engineer Weed Man’s dynamic pricing engine across key MSAs.
